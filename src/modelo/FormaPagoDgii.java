 ...
 */
@Entity
@Table(name = "forma_pago_dgii")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "FormaPagoDgii.findAll", query = "SELECT f FROM FormaPagoDgii f")
    , @NamedQuery(name = "FormaPagoDgii.findByCodigo", query = "SELECT f FROM FormaPagoDgii f WHERE f.codigo = :codigo")
    , @NamedQuery(name = "FormaPagoDgii.findByNombre", query = "SELECT f FROM FormaPagoDgii f WHERE f.nombre = :nombre")})
public class FormaPagoDgii implements Serializable {
    ...
    public FormaPagoDgii() {
    }

    public FormaPagoDgii(Integer codigo) {
        this.codigo = codigo;
    }

    public FormaPagoDgii(Integer codigo, String nombre) {
        this.codigo = codigo;
        this.nombre = nombre;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FormaPagoDgii)) {
            return false;
        }
        FormaPagoDgii other = (FormaPagoDgii) object;
    ...
    public String toString() {
        return "modelo.FormaPagoDgii[ codigo=" + codigo + " ]";
    }
