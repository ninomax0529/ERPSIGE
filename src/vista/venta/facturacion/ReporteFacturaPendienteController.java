 ...
 */
public class ReporteFacturaPendienteController implements Initializable {
...
//            Date fechaFinal = ClaseUtil.asDate(dpFechaFinal.getValue());
            ...
            RptFactura.getInstancia().reporteFacturaPendiente(sqlParam, fechaInicio, fechaFinal);
