 ...
 * @author MAXIMILIANO
 */
public class RptCobrosPorDias {

    private URL ruta_maestro;
    private URL ruta_img;
    private URL urlsub;
    public static RptCobrosPorDias manager;
    ...
    public static RptCobrosPorDias getInstancia() {
        if (manager == null) {
            manager = new RptCobrosPorDias();
            return manager;
        }
        return manager;
    }
     ...
     */
    public RptCobrosPorDias() {

        try {

            ruta_maestro = getClass().getResource("/reporte/cobros/RptCobroPorDias.jasper");
...
//            }
    ...
    public void imprimir(Date fi, Date ff, String sqlParam, String tipoRecibo) {
        ...
        parametros.put("tipoRecibo", tipoRecibo);
