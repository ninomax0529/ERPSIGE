...
//    private JasperReport SUB_RPT_DETALLE_ORDEN;
    ...
    public RptFacturaIghTrack() {
        ...
        try {
            ...
            ruta_maestro_original = getClass().getResource("/reporte/ightrack/jasper/RptFacturaClienteIghTrack.jasper");
            ruta_maestro_temporal = getClass().getResource("/reporte/ightrack/jasper/RptFacturaClienteIghTrackTemporal.jasper");
            RUTA_SUB_RPT_DETALLE_FACTURA = getClass().getResource("/reporte/ightrack/jasper/subRptDetFacturaIghTrack.jasper");
            RUTA_SUB_RPT_DETALLE_FACTURAAGRUPADO = getClass().getResource("/reporte/ightrack/jasper/subRptDetAgrupoadoFacturaIghTrack.jasper");
            RUTA_SUB_RPT_DETALLE_FACTURA_TEMPORAL = getClass().getResource("/reporte/ightrack/jasper/subRptDetalleFacturaIghTrackTemporal.jasper");
            RUTA_SUB_RPT_DETALLE_DATOS_VEHICULO = getClass().getResource("/reporte/ightrack/jasper/subRptDetalleDatoVehiculoIghTrack.jasper");
...
//            carpeta = new File(rutaStr);
    ...
    public void imprimirPorLote(Factura factura) {
     ...
     public void imprimirFactPorLote(Factura factura) {
