 ...
 * @author MAXIMILIANO
 */
public class RptEntradaInventario {
    ...
    public static RptEntradaInventario manager;
    ...
    public static RptEntradaInventario getInstancia() {
        if (manager == null) {
            manager = new RptEntradaInventario();
            return manager;
        }
        return manager;
    }
