 ...
 * @author maximiliano
 */
public class RpCotizacionDeVentaPinturaTriplea {

    public static RpCotizacionDeVentaPinturaTriplea manager;
...
//Cierre declaracion ruta 
    public static RpCotizacionDeVentaPinturaTriplea getInstancia() {

        if (manager == null) {

            manager = new RpCotizacionDeVentaPinturaTriplea();
            return manager;
        }
        return manager;
    }
...
//    private JasperReport SUB_RPT_DETALLE_ORDEN;
     ...
     */
    public RpCotizacionDeVentaPinturaTriplea() {

        try {

            ruta_maestro_original = getClass().getResource("/reporte/cotizacion/RptCotizacionClientePinturaTriplea.jasper");
            RUTA_SUB_RPT_DETALLE_FACTURA = getClass().getResource("/reporte/cotizacion/subRptDetalleCotizacionPinturaTriplea.jasper");
