...
public class RptCxc {
    ...
    public static RptCxc manager;

    public static RptCxc getInstancia() {
...
//            }
    ...
    public void ventasPorDia(Date fechaDesde, Date fechaHasta, String sqlParam) {
