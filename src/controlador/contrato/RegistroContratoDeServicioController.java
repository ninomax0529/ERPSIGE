 ...
 */
public class RegistroContratoDeServicioController implements Initializable {
...
//                        hbox.getChildren().addAll(imageview);
    ...
    private void inicializarCombox() {
        ...
        cbTipoDeServicio.getSelectionModel().select(0);
...
//            getCliente().setMontoDisponible(ManejoFactura.getInstancia().getMontoDisponible(getCliente()));
    ...
    private void btnAgregarActionEvent(ActionEvent event) {
        ...
        Double precio = ManejoListaDePrecio.getInstancia().getPrecioVentaDeArticulo(getArticulo().getCodigo(), un.getCodigo());
        det.setPrecioPagado(precio);
        System.out.println("Precio pagado : " + det.getPrecioPagado());

        if (precioPorDia > 0 && chNuevaModalidad.isSelected()) {

            det.setFechaDesde(ClaseUtil.asDate(dpFechaDesde.getValue()));
            det.setFechaHasta(fechacorteAnio);
            det.setPrecioPagado(precioPorDia);
...
//            det = new DetalleContratoDeServicio();
//
//            System.out.println("Segundo servicio "+precio);
//            
//            det.setFechaDesde(fechacorteAnio);
//            det.setFechaHasta(ClaseUtil.asDate(dpFechaHasta.getValue()));
//            det.setPrecioPagado(precio);
//            det.setDescripcion(desc2);
//            det.setRecurrente(true);
//
//            agregarServicio();
...
//            taskGuardarContrato.run();
    ...
    private void nuevo() {
        ...
        txtCantidadFrecuencia.setText("1");
    ...
    private void dpFechaDesdeActionEvent(ActionEvent event) {
        ...
        try {
            ...
            if (!(dpFechaDesde.getValue() == null) && !txtCantidadFrecuencia.getText().isEmpty()) {
                ...
                if (cbFrecuenciaDePagoDet.getSelectionModel().getSelectedItem().getCodigo() == 1) {//Servicio anual
                    ...
                    diaDeRenovacion = ManejoUnidadDeNegocio.getInstancia().getUnidad(2).getDiaDeFacturacion();
                ...
                if (cbTipoDeServicio.getSelectionModel().getSelectedItem().getCodigo() == 1) {//GPS
                    ...
                    if (getArticulo().getNombre().contains("EQUIPO")) {
                        ...
                        if (chNuevaModalidad.isSelected()) {
                            ...
                            fechaVencimiento = ClaseUtil.FechaMesDespues(fechacorteAnio, cantidadFecuenciaPago.intValue());
                            ...
                            desc2 = txtCantidadFrecuencia.getText() + " " + cbFrecuenciaDePagoDet.getSelectionModel().getSelectedItem().getDescripcion()
                                    + " POR SERVICIO DE " + cantidadGPS + " GPS DESDE  " + new SimpleDateFormat("dd/MM/yyyy").format(fechacorteAnio)
                                    + " AL " + new SimpleDateFormat("dd/MM/yyyy").format(fechaVencimiento);
                    ...
                    if (getArticulo().getNombre().contains("EQUIPO")) {
                        ...
                        if (chNuevaModalidad.isSelected()) {
                            ...
                            desc2 = txtCantidadFrecuencia.getText() + " " + cbFrecuenciaDePagoDet.getSelectionModel().getSelectedItem().getDescripcion()
                                    + " POR " + cantidadGPS + " SERVICIO DESDE  " + new SimpleDateFormat("dd/MM/yyyy").format(fechacorteAnio)
                                    + " AL " + new SimpleDateFormat("dd/MM/yyyy").format(fechaVencimiento);
                    ...
                    if (getArticulo().getNombre().contains("EQUIPO")) {
                        ...
                        if (chNuevaModalidad.isSelected()) {
                            ...
                            desc2 = txtCantidadFrecuencia.getText() + " " + cbFrecuenciaDePagoDet.getSelectionModel().getSelectedItem().getDescripcion()
                                    + " POR 1 SERVICIO DESDE  " + new SimpleDateFormat("dd/MM/yyyy").format(fechacorteAnio)
                                    + " AL " + new SimpleDateFormat("dd/MM/yyyy").format(fechaVencimiento);
