 ...
 */
public class ModuloReportesController implements Initializable, InicializarMenu {
...
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            ...
            Logger.getLogger(ModuloReportesController.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
    ...
    public void inicializarMenu() {
        ...
        AdministrarMenu.getInstancia().agregarOpciones(vbMenu, 12);
        AdministrarMenu.getInstancia().activarOpciones(vbMenu, 12, codigoRol);
    ...
    @FXML
    private void btnVentasActionEvent(ActionEvent event) {

        try {

            Node node = (Node) FXMLLoader.load(getClass().getResource("/vista/reportes/venta/ReporteDeVentas.fxml"));
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            bpVenta.setCenter(node);
    ...
    @FXML
    private void btnCxCActionEvent(ActionEvent event) {

        try {

            Node node = (Node) FXMLLoader.load(getClass().getResource("/vista/reportes/cxc/ReporteCuentasPorCobrar.fxml"));
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            bpVenta.setCenter(node);
    ...
    @FXML
    private void btnCobrosActionEvent(ActionEvent event) {

        try {

            Node node = (Node) FXMLLoader.load(getClass().getResource("/vista/reportes/cobros/RptCobros.fxml"));
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            bpVenta.setCenter(node);
    ...
    @FXML
    private void btnCxPActionEvent(ActionEvent event) {
    }

    @FXML
    private void btnFlotaActionEvent(ActionEvent event) {

        try {

            Node node = (Node) FXMLLoader.load(getClass().getResource("/vista/reportes/flota/ReporteDeFlota.fxml"));
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            bpVenta.setCenter(node);
    ...
    @FXML
    private void btnContabilidadActionEvent(ActionEvent event) {

        try {

            Node node = (Node) FXMLLoader.load(getClass().getResource("/vista/reportes/contabilidad/ReporteContabilidad.fxml"));
//            lbModulo.setText("Modulo Contrato de Servicio -> Rgistro de Contrato");
            bpVenta.setCenter(node);
