 ...
 */
public class PedidosPendienteController implements Initializable {
...
//        gpDetallePedido.setVgap(5);
        gpPedido.setAlignment(Pos.CENTER_LEFT);
...
//            btn.getStylesheets().add(getClass().getResource("/css/btn_articulos.css").toExternalForm());
    ...
    private void btnReimprimirActionEvent(ActionEvent event) {
        ...
        try {
            ...
            System.out.println("Estado anteriorm " + pedidoObj.getEstado());
            pedidoObj.setEstado(ManejoEstadoPedido.getInstancia().getEstadoPedido(2));//Estado 2 Pedido listo para delive;
            pedidoObj.setHoraEmpacado(new Date());

            System.out.println("Estado actualizado " + pedidoObj.getEstado());
            ...
            if (!(pedidoactualizado == null)) {
                ...
                ManejoExistenciaArticulo.getInstancia().actualizarExistenciaPorSalidaDePedido(listaDetallePedido);
    ...
    private void btnAnularActionEvent(ActionEvent event) {
        ...
        try {
            ...
            ClaseUtil.mensaje("Hubo error anulando el pedido ");
            e.printStackTrace();
        }
...
//        }
    ...
    private void btnEditarActionEvent(ActionEvent event) {
        ...
        try {
            ...
            loader.setLocation(getClass().getResource("/vista/venta/pedido/PedidoTochGridPaneUltimo.fxml"));
            loader.load();

            Parent root = loader.getRoot();

            PedidoTochGridPaneUltimoController pedidoTochGridPaneController = loader.getController();
