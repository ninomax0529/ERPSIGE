...
public class ClienteController implements Initializable {
    ...
    @FXML
    private TableColumn<Cliente, String> tbcRepresentante;
    @FXML
...
//                        imageFile = new File(getClass().getResource("/imagen/img_documento.jpg").toString());
    ...
    public void iniciarTabla() {
        ...
        tbcRepresentante.setCellValueFactory(new PropertyValueFactory<>("personaResponsable"));
    ...
    private void iniciazarFiltro() {
        ...
        txtFiltro.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            filteredData.setPredicate(filtro -> {
                ...
                } else if (filtro.getPersonaResponsable()!= null && filtro.getPersonaResponsable().toLowerCase().contains(lowerCaseFilter)) {
                    return true; // Filter matches last name.
                }
